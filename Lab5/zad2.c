...
//=======================================================
int znajdz_nazwisko(char naz[NAZW_MAX+1], char im[IMIE_MAX+1], int *p)
{
...
//=======================================================
int znajdz_imie(char im[NAZW_MAX+1], char naz[IMIE_MAX+1], int *p)
{
